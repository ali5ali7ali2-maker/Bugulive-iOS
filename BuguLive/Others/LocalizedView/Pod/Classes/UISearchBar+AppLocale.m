...
//    }
    ...
    self.text = ASLocalizedString(self.text);
    self.placeholder = AMLocalizedString(self.placeholder, nil);
    
    self.prompt = ASLocalizedString(self.prompt);
    
    [LocalizationSystem checkXibString:self.placeholder];
    [LocalizationSystem checkXibString:self.prompt];
