...
// MARK: --<#(MARK)#>--
#define SkinWhiteningValue 40 // 美白拉条默认参数
#define SkinBlemishRemovalValue 60 // 磨皮拉条默认参数
...
#define EyeMagnifyingValue 40 // 大眼拉条默认参数
#define ChinSlimmingValue 50 // 瘦脸拉条默认参数
#define FaceNarrowingValue 50 // 窄脸拉条默认参数
