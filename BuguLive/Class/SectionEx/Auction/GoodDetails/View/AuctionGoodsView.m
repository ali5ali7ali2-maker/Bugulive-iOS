...
- (instancetype)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame])
    {
        ...
        [BGMJRefreshManager refresh:_auctionGoodsTable target:self headerRereshAction:@selector(headerRefresh) shouldHeaderBeginRefresh:NO footerRereshAction:@selector(footerReresh)];
...
- (void)loadDataWithPage:(int)page
{
    ...
    [self.httpsManager POSTWithParameters:mDict SuccessBlock:^(NSDictionary *responseJson) {
        ...
        [BGMJRefreshManager endRefresh:self.auctionGoodsTable];
...
- (void)footerReresh
{
    ...
    {
        [BGMJRefreshManager endRefresh:_auctionGoodsTable];
    }
}
