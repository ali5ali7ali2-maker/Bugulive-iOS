...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self)
    {
        ...
        self.detailLabel.text = ASLocalizedString(@"拍品详情");
...
- (void)changeHeight:(UIButton *)button
{
    if (self.buttonCount == 0)
    {
        ...
        //[self.clickButton setTitle:ASLocalizedString(@"[收起]")forState:UIControlStateNormal];
        
    }else
    {
        self.buttonCount = 0;
        self.downUpImgView.image = [UIImage imageNamed:@"com_arrow_down_2"];
        //[self.clickButton setTitle:ASLocalizedString(@"[展开]")forState:UIControlStateNormal];
