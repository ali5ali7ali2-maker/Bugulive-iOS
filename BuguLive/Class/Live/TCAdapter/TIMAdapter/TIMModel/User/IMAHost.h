...
@property (nonatomic, strong)NSString                     *has_car;//是否拥有座驾
@property (nonatomic, strong)NSString                     *car_name;//座驾名称
@property (nonatomic, strong)NSString                     *car_svga;//座驾svg地址
@property (nonatomic, strong)NSString                     *is_vip;//是否是vip
@property(nonatomic, strong) NSString *colorful;
- (NSString *)userId;
