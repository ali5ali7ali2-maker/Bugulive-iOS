...
typedef NS_ENUM(NSInteger, AVIMCommand)
{
    ...
    //pk操作
    MSG_REQEUST_PK              = 55,//请求pk
    MSG_ACCEPT_PK              = 56,//同意pk
    MSG_REJECT_PK              = 57,//拒绝pk
    MSG_STOP_PK              = 58,//停止pk
    MSG_CANCEL_PK              = 59,//取消pk
    MSG_START_PK              = 60,//通知房间开始pk
    MSG_END_PK              = 61,//pk结束
    UPDATE_PK_TICKET              = 70,//更新pk收益
    MSG_WISH_UPDATE             = 71,//更新直播间心愿列表.
    
    MSG_OPEN_GUARD_SUCCESS = 81,//开通守护之后群组通知
    
    MSG_RECEIVE_BROADCAST = 82, //全局广播通知
    
    MSG_WIN_PRIZE = 88,//中奖提示消息
    
    MSG_OPEN_VIP_TYPE = 91,//贵族开通消息
    
    MSG_SHOP_SAY_TYPE = 200,//商品-主播开始讲解
    MSG_SHOP_SAY_CANCLE_TYPE = 201,//商品-主播取消讲解
    
    
    MSG_RECEIVE_GUILD_REFRESH_TYPE = 300,//收到公会消息
    MSG_REFRESH_VOICE_Lianmai = 747,//连麦消息
    MSG_REFRESH_VOICE_MSG = 745,//幸运礼物
    MSG_LianMai_Mute = 748,//幸运礼物
    //302 更新语音房间信息
    MSG_REFRESH_VOICE_ROOM_INFO = 302,
    //更新座位列表303
    MSG_REFRESH_SEAT_LIST = 303,
   //发送表情
    MSG_SEND_EMOTION = 84,
