...
@property (nonatomic, strong) NSString *total_num;       // 印票总数
...
// 消息发送者的信息
@property(nonatomic, strong) NSString *pk_id;//pkid
...
@property (nonatomic, copy) NSString            *pkid;               // 消息
@property (nonatomic, assign) NSInteger           status;             //pk状态
//@property (nonatomic, assign) NSInteger guardian;                //守护状态1是守护,2不是守护
@property (nonatomic, assign) NSInteger is_guardian;                //守护状态1是守护,2不是守护
...
@property (nonatomic, copy) NSString *user_multiple;

@property (nonatomic, copy) NSString *win_user_id;
...
@property(nonatomic, copy) NSString *prop_coin;//需要累加魅力值
