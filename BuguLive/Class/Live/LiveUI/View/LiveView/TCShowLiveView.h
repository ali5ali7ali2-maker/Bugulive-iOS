...
@interface TCShowLiveView : BGBaseView <TCShowLiveBottomViewDelegate, GiftViewDelegate,UIGestureRecognizerDelegate,GoldFlowViewDelegate,TCShowLiveInputViewDelegate,ApplyBankerViewDelegate,SelectBankerViewDelegate,ExchangeCoinViewDelegate,MoreToolsViewDelegate,GuessSizeViewDelegate,GameWinViewDelegate>
{
...
@property (nonatomic, copy) TCShowVoiceBottomView    *voicebottomView;
...
@property(nonatomic, strong)  MGShowLiveWishView              *livewWishView;//直播心愿view（左侧）


@property(nonatomic, strong)  UIButton              *liveVipBtn;//贵族列表（右侧）
