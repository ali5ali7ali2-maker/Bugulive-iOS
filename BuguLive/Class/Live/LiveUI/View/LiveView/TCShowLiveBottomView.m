...
- (void)hostAddFunc
{
    ...
    if ([[GlobalVariables sharedInstance].appModel.is_open_shop isEqualToString:@"1"]) {
        [self addFunc:EFunc_SHOP];
    }
    
    self.shopBtn.hidden = ![GlobalVariables sharedInstance].isShop;
    
    [self addFunc:EFunc_WISH];
    ...
    if (_liveInfo.push_type.integerValue == 1) {
        [self addFunc:EFunc_PK];
    }
...
- (void)audienceAddFunc
{
    ...
    [self addFunc:EFunc_CHART];
    [self addFunc:EFunc_RED_PACK];

    if (_liveInfo.has_lianmai && _liveInfo.push_type.integerValue == 1)
    {
...
- (void)addFunc:(NSInteger)funcid
{
    ...
    switch (funcid)
    {
        ...
        {
            menuBtn = [[MenuButton alloc] initWithTitle:nil icon:[UIImage imageNamed:@"游戏底部"] action:^(id<MenuAbleItem> menu) {
        ...
        case EFunc_RED_PACK:
        {
            menuBtn = [[MenuButton alloc] initWithTitle:nil icon:[UIImage imageNamed:@"hongbao1"] action:^(id<MenuAbleItem> menu) {
                
                FWStrongify(self)
                [self menuButtonAction:menu];
                
            }];
            [menuBtn setImage:[UIImage imageNamed:@"hongbao1"] forState:UIControlStateSelected];
        }
            break;
            
        case EFunc_GIFT:
        {
            menuBtn = [[MenuButton alloc] initWithTitle:nil icon:[UIImage imageNamed:@"lr_bottom_gift_list"] action:^(id<MenuAbleItem> menu) {
        ...
        {
            menuBtn = [[MenuButton alloc] initWithTitle:nil icon:[UIImage imageNamed:@"lr_bottom_connect_mick"] action:^(id<MenuAbleItem> menu) {
        ...
        case EFunc_SHARE:
        {
            menuBtn = [[MenuButton alloc] initWithTitle:nil icon:[UIImage imageNamed:@"lr_bottom_share"] action:^(id<MenuAbleItem> menu) {
        ...
        case EFunc_CHART:
        {
            menuBtn = [[MenuButton alloc] initWithTitle:nil icon:[UIImage imageNamed:@"lr_bottom_private_msg"] action:^(id<MenuAbleItem> menu) {
        ...
        {
            menuBtn = [[MenuButton alloc] initWithTitle:nil icon:[UIImage imageNamed:@"ic_live_bottom_saleWindowBtn"] action:^(id<MenuAbleItem> menu) {
        ...
        {
            menuBtn = [[MenuButton alloc] initWithTitle:nil icon:[UIImage imageNamed:@"lr_bottom_changepay"] action:^(id<MenuAbleItem> menu) {
        ...
        {
            menuBtn = [[MenuButton alloc] initWithTitle:nil icon:[UIImage imageNamed:@"lr_bottom_mention"] action:^(id<MenuAbleItem> menu) {
        ...
        {
            menuBtn = [[MenuButton alloc] initWithTitle:nil icon:[UIImage imageNamed:@"lr_bottom_full_screen"] action:^(id<MenuAbleItem> menu) {
        ...
        case EFunc_PK:  // PK
        {
            menuBtn = [[MenuButton alloc] initWithTitle:nil icon:[UIImage imageNamed:@"PK2"] action:^(id<MenuAbleItem> menu) {
                
                FWStrongify(self)
                [self menuButtonAction:menu];
                
            }];
            [menuBtn setImage:[UIImage imageNamed:@"PK2"] forState:UIControlStateSelected];
        }
            break;
        case EFunc_SHOP:  // 购物车
        {
            menuBtn = [[MenuButton alloc] initWithTitle:nil icon:[UIImage imageNamed:@"lr_bottom_shop"] action:^(id<MenuAbleItem> menu) {
                
                FWStrongify(self)
                [self menuButtonAction:menu];
                
            }];
            [menuBtn setImage:[UIImage imageNamed:@"lr_bottom_shop"] forState:UIControlStateSelected];
            _shopBtn = menuBtn;
        }
            break;
        ...
        case EFunc_WISH:  // 心愿单
        {
            menuBtn = [[MenuButton alloc] initWithTitle:nil icon:[UIImage imageNamed:@"lr_bottom_wish"] action:^(id<MenuAbleItem> menu) {
                
                FWStrongify(self)
                [self menuButtonAction:menu];
                
            }];
            [menuBtn setImage:[UIImage imageNamed:@"lr_bottom_wish"] forState:UIControlStateSelected];
        }
            break;
            
        case EFunc_CLOSE:  // 购物车
        {
            menuBtn = [[MenuButton alloc] initWithTitle:nil icon:[UIImage imageNamed:@"lr_bottom_close"] action:^(id<MenuAbleItem> menu) {
                
                FWStrongify(self)
                [self menuButtonAction:menu];
                
            }];
            [menuBtn setImage:[UIImage imageNamed:@"lr_bottom_close"] forState:UIControlStateSelected];
//            _shopBtn = menuBtn;
        }
            break;
