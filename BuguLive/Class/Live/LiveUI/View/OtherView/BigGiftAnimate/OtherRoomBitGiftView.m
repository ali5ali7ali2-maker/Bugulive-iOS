...
- (void)judgeGiftViewWith:(NSString *)str finishBlock:(FWVoidBlock)finishBlock
{
    ...
    self.largeGiftBtn.frame = CGRectMake(CGRectGetMinX(self.largeGiftBtn.frame), CGRectGetMinY(self.largeGiftBtn.frame) + kRealValue(5), strSize.width + 70, CGRectGetHeight(self.largeGiftBtn.frame));
    
    [self.largeGiftBtn setBackgroundImage:[BGUtils resizableImage:@"lr_bg_fly_gift"] forState:UIControlStateNormal];
