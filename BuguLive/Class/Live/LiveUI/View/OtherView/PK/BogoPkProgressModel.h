...
@class BogoPkProgressGiftModel;

@interface BogoPkProgressModel : NSObject
...
@property(nonatomic, strong) NSString *pk_ticket1;
...
@property (nonatomic, strong) NSArray<BogoPkProgressGiftModel *> *gift_list1;

@property (nonatomic, strong) NSArray<BogoPkProgressGiftModel *> *gift_list2;
//
@property(nonatomic, strong) NSString *push_url1;
@property(nonatomic, strong) NSString *push_url2;

@end



@interface BogoPkProgressGiftModel : NSObject
