...
//        self.shareFollowBtn.layer.borderColor = kWhiteColor.CGColor;
        [self.shareFollowBtn setBackgroundImage:[UIImage imageNamed:@"ic_live_shareFollowBtn"] forState:UIControlStateNormal];
...
//        self.backHomeBtn.layer.cornerRadius = CGRectGetHeight(self.backHomeBtn.frame)/2;
        [self.backHomeBtn setBackgroundImage:[UIImage imageNamed:@"ic_live_backHome"] forState:UIControlStateNormal];
        [self.backHomeBtn setTitleColor:[UIColor colorWithHexString:@"#CC45FF"] forState:UIControlStateNormal];
        self.ticketNameLabel.text = [NSString stringWithFormat:ASLocalizedString(@"获得%@"),self.BuguLive.appModel.ticket_name];
