...
@interface SLiveHeadInfoView : BGBaseView<UIActionSheetDelegate,UIGestureRecognizerDelegate>
...
@property (weak, nonatomic) IBOutlet UIImageView *bigBottomView;
...
@property (weak, nonatomic) IBOutlet UIImageView *nobleTopImgView;
...
@property (weak, nonatomic) IBOutlet NSLayoutConstraint *bgImageWidthConstraint;
...
@property (weak, nonatomic) IBOutlet QMUIButton *identifitionBtn;
@property (weak, nonatomic) IBOutlet NSLayoutConstraint *sexRightRankConstraint;


@property(nonatomic, copy) void (^clickAttentionBlock)(BOOL isAttention);
