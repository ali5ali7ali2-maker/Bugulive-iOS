...
@interface SLiveRedBagView : BGBaseView<UITableViewDelegate,UITableViewDataSource>
...
@property (weak, nonatomic) IBOutlet UIButton *luckNewButton;
@property (weak, nonatomic) IBOutlet NSLayoutConstraint *headImgHeightConstraint;
@property (weak, nonatomic) IBOutlet NSLayoutConstraint *headImgWidthConstraint;
