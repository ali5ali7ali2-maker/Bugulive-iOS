...
- (void)setModel:(GoodsModel *)model
{
    ...
    else
    {
        ...
        else if (_type==1)
        {
            ...
            [_sendAnchorBtn setTitle:ASLocalizedString(@"送给主播")forState:UIControlStateNormal];
            [_giveSelfBtn setTitle:ASLocalizedString(@"买给自己")forState:UIControlStateNormal];
