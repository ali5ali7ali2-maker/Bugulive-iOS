...
@interface BGTPlayController : UIViewController
{
...
@property (nonatomic, strong) UIImageView *pkBgView;
@property (nonatomic, strong) TXLivePlayer  *txLivePlayer;
@property (nonatomic, strong) TXLivePlayer  *rightTxLivePlayer;
@property (nonatomic, strong) UIView        *videoContrainerView;   // 放置视频的view

//声网dev
@property (nonatomic, strong) UIView        *videoContrainerViewAgora;   // 放置视频的view

@property (nonatomic, strong) UIView        *rightVideoContrainerView;   // 放置视频的view
