...
class LiveViewController: UIViewController {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if "beginLivePush" == segueId { /// 开始直播
            let liveVC = segue.destination as? TRTCLivePushViewController
...
extension LiveViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let vc = storyboard.instantiateViewController(withIdentifier: "LivePlayViewControllerId") as? TRTCLivePlayViewController
        if nil != vc {
