...
- (void)addSubViews
{
    ...
    {
        _reLiveProgressView = [[BGReLiveProgressView alloc]init];
...
- (void)initLive
{
    ...
    {
        _ksyPlayerController = [[BGKSYPlayerController alloc] init];
...
- (void)onPKViewChange:(NSNotification *)notify
{
    ...
    else if(isFull == 4)
    {
        ...
        if(_isHost)
        {
            ...
            #else
            _agoraLinkMicStreamerController.gPUStreamerKit.winRect = CGRectMake(0, 0, 0.5, 0.5);
            _agoraLinkMicStreamerController.gPUStreamerKit.winPKRect = CGRectMake(0.5, 0, 0.5, 0.5);
            [_agoraLinkMicStreamerController.gPUStreamerKit setPKModel:YES];
            #endif
        }
    }
