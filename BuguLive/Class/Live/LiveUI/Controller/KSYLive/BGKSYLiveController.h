 ...
 *
 *  BGKSYLinkMicStreamerController          ：   主播控制类（金山连麦）
 *  BGKSYLinkMicPlayerController            ：   观众控制类（金山连麦）
 *
 *  BGKSYAgoraLinkMicStreamerController     ：   主播控制类（声网连麦）
 *  BGKSYAgoraLinkMicPlayerController       ：   观众控制类（声网连麦）
 *
 *  BGKSYPlayerController                   ：   金山云点播（回放、回播）控制类
 *
...
@private
    ...
    BGSettingBeautyView     *_beautyView;           // 美颜视图
...
// 金山云点播（回放、回播）控制类
@property (nonatomic, strong) BGKSYPlayerController                     *ksyPlayerController;

// 主播控制类（金山连麦）
@property (nonatomic, strong) BGKSYLinkMicStreamerController            *ksyLinkMicStreamerController;
// 观众控制类（金山连麦）
@property (nonatomic, strong) BGKSYLinkMicPlayerController              *ksyLinkMicPlayerController;

// 主播控制类（声网连麦）
@property (nonatomic, strong) BGKSYAgoraLinkMicStreamerController       *agoraLinkMicStreamerController;
// 观众控制类（声网连麦）
@property (nonatomic, strong) BGKSYAgoraLinkMicPlayerController         *agoraLinkMicPlayerController;

// 点播进度条容器视图
@property (nonatomic, strong) BGReLiveProgressView          *reLiveProgressView;
// 直播业务层
