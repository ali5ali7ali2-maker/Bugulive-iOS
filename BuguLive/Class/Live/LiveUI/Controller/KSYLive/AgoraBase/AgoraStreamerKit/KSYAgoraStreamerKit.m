...
@property(nonatomic, assign) BOOL isPkModel;
@end
...
//    _agoraKit = [[KSYAgoraClient alloc] initWithAppId:AgoraAppId delegate:self];
//    _beautyOutput = nil;
//    _callstarted = NO;
//    _maskPicture = nil;
...
//        strongSelf.videoPts= CMSampleBufferGetPresentationTimeStamp(buf);
//    };
//
...
//        if(channel)
//        {
//            if(!self.beautyOutput)
//            {
//                [self setupBeautyOutput];
//                [self setupRtcFilter:self.curfilter];
//            }
//
//            if(self.onChannelJoin)
//                self.onChannelJoin(200);
//        }
//    };
//
//    //离开channel成功回调
...
//        FWStrongify(self)
//        [self defaultRtcVideoCallback:buf];
//    };
//
//    //音频回调，放入amixer里面
...
//    {
//        FWStrongify(self)
//        if(CMTIME_IS_INVALID(self.localAudioPts)){
//            self->_localAudioPts = self->_videoPts;
//        }else{
//            int nb_sample = len/bytesPerSample;
//            int64_t timescale = self.localAudioPts.timescale;
//            int64_t dur =(nb_sample*timescale)/sampleRate;
//            self->_localAudioPts.value +=dur;
//        }
//
//        [self defaultRtcVoiceCallback:buffer len:len pts:self.localAudioPts channel:channels sampleRate:sampleRate sampleBytes:bytesPerSample trackId:0];
//    };
//
//
//    //注册进入后台的处理
...
//}
//- (void)dealloc {
//    NSLog(ASLocalizedString(@"KSYAgoraStreamerKit 释放%s"),__func__);
//    if(_agoraKit){
...
//}
//
//-(void)setPKModel:(BOOL)isPkModel
//{
//    _isPkModel = isPkModel;
//
...
//        if(isPkModel)
//        {
//            [vMixer[i] setPicRect:_winPKRect ofLayer:self.cameraLayer];
//        }
//        else
//        {
//            [vMixer[i] setPicRect:CGRectMake(0, 0, 1, 1) ofLayer:self.cameraLayer];
//        }
//    }
