...
//头饰比例BGTRTCLiveController
#define headdressRatio                (86/64.0)          // (80/50.0)
// View 圆角
...
#define kAppNewMainColor            [UIColor colorWithHexString:@"#BF45FF"]              // app主色调
...
#define KMGLineColor        [UIColor colorWithHexString:@"#E1E1E1"]
#define KMGMainBGColor      kWhiteColor
#define KMGMainFontColor    kBlackColor
#define KMGMainBlueFontColor    [UIColor colorWithHexString:@"#14D8E5"]
...
// 直播页的相关色值
#define myTextColorUser                 [UIColor colorWithHexString:@"#6CF4EC"]          // 用户名
//@"6cc9e6"
#define myTextColorCommonMessageUser  [UIColor colorWithHexString:@"#6CF4EC"]
//[UIColor colorWithHexString:@"40aa53"]          // 用户名
#define myTextColorCommonMessage        RGB(255, 255, 255)          // 普通消息颜色
#define myTextColorSendGift             [UIColor colorWithHexString:@"ff4081"]           // 送礼物时的颜色
#define myTextColorLivingMessage        [UIColor colorWithHexString:@"#6CF4EC"]
//@"40aa53"]            // 直播消息颜色
...
// 公会
#define kFamilyBackGroundColor      RGB(236,236,236)    // 公会详情背景的颜色
#define kAppFamilyBtnColor          RGB(95,204,174)     // 公会相关按钮颜色（拒绝按钮，创建公会按钮颜色）
...
#define Main_textColor UIColorFromRGB(0x7e37fb)

//RGB(246, 246, 246)
#define navigationBGColor UIColorFromRGB(0xffffff)
#define navtionTitleColor [UIColor blackColor]
#define navtionTitleFont [UIFont systemFontOfSize:18 weight:.2]
