...
#define KRecordingEnd @"RecordingEnd"
...
#define COMMENT_TABLEVIEW_WIDTH                 kScreenW*0.65         // 普通消息容器视图宽度
...
#define kLiveTopRightNumWidth                    80          // 直播间当前人气

#define kShoppingHeight                         kScreenH-1.5*0.4*kScreenW  //直播购物视图高度
#define BARRAGE_VIEW_Y_1                        kScreenH-kSendGiftContrainerHeight-COMMENT_TABLEVIEW_HEIGHT-15-35 - 35 -120  //弹幕视图1(底下的)的Y值
#define BARRAGE_VIEW_Y_2                        BARRAGE_VIEW_Y_1 - 36
//弹幕视图2(上面的)的Y值
...
#define kAudienceEnteringTipViewHeight          kScreenH-kSendGiftContrainerHeight-COMMENT_TABLEVIEW_HEIGHT-15-35 - 35   //观众进入提示视图的Y值·

#define kOpenTipViewHeight kLogoContainerViewHeight + 70
...
//
    MPCMySmallShop,                 //我的小店
    MPCInviteUser,                     //邀请赚钱
    MPCRenZhenSection,                 //主播认证
    MPCIncomeSection,                  //分享收益
    MPCContributeSection,              //贡献榜
    MPCSZJLSection,                    //直播间收支记录
    MPCSetSection,                     //设置
    
    MPCSetInvateCode,                   //邀请码
    MPCAcountSection,                  //账户
    ...
    MPCFamilySection,                  //我的公会
    MPCTradeSection,                   //我的公会
    
    MPCMyInfoSection,                   //我的主页
    MPCMyEditSection,                   //我的编辑页
    
    
    MPCMyVideoSection,                   //小视频
...
#define kPKChangeToPunish @"kPKChangeToPunish"
