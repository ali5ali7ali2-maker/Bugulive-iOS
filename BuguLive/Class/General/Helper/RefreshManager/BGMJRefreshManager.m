...
#import "BGMJRefreshManager.h"

@implementation BGMJRefreshManager
...
{
    [BGMJRefreshManager refresh:refreshedView target:target headerRereshAction:headerRereshAction shouldHeaderBeginRefresh:YES footerRereshAction:footerRereshAction];
}
...
{
    [BGMJRefreshManager refresh:refreshedView target:target headerRereshAction:headerRereshAction shouldHeaderBeginRefresh:shouldHeaderBeginRefresh footerRereshAction:footerRereshAction refreshFooterType:@"MJRefreshBackNormalFooter"];
}
...
+ (void)refresh:(UIScrollView *)refreshedView target:(id)target headerRereshAction:(SEL)headerRereshAction shouldHeaderBeginRefresh:(BOOL)shouldHeaderBeginRefresh headerWithRefreshingBlock:(FWRefreshComponentRefreshingBlock)headerWithRefreshingBlock footerRereshAction:(SEL)footerRereshAction refreshFooterType:(NSString *)refreshFooterType
{
    ...
    if (footerRereshAction)
    {
        ...
        if (![BGUtils isBlankString:refreshFooterType])
        {
