...
@interface BGBaseWebViewController : BGBaseViewController <WKNavigationDelegate, WKUIDelegate>
...
@property (nonatomic, assign) BOOL      isCanShowRightBarRefreshBtn;    // 是否能够显示导航栏右侧刷新按钮
...
@property (nonatomic, assign) BOOL      isShowSegHead;                  // 是否有SegHeight
