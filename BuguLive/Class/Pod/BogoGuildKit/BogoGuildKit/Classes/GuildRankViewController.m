...
@interface GuildRankViewController ()
...
@implementation GuildRankViewController
...
- (void)addSubController {
    _segHead = [[MLMSegmentHead alloc] initWithFrame:CGRectMake(0, 0, self.view.fd_width, 40) titles:@[ASLocalizedString(@"总榜"),ASLocalizedString(@"周榜"),ASLocalizedString(@"日榜")] headStyle:SegmentHeadStyleLine layoutStyle:MLMSegmentLayoutDefault];
    _segHead.tag = 1101;
    //tab颜色
...
-(NSMutableArray *)vcArray{
    if (!_vcArray) {
        ...
        allVC.type = GuildRankSubViewControllerTypeAll;
        [_vcArray addObject:allVC];
        GuildRankSubViewController *weekVC = [[GuildRankSubViewController alloc]initWithNibName:@"GuildRankSubViewController" bundle:kBogoGuildKitBundle];
        weekVC.type = GuildRankSubViewControllerTypeWeek;
        [_vcArray addObject:weekVC];
        ...
        dayVC.type = GuildRankSubViewControllerTypeDay;
