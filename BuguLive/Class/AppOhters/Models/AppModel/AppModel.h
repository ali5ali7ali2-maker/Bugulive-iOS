...
@property (nonatomic, assign) NSInteger     fb_app_api;             // 是否facebook分享
...
@property(nonatomic, copy) NSString *Withdrawal_agree;
...
@property (nonatomic, copy) NSString        *app_name;              // app名称  布谷直播
...
@property (nonatomic, copy) NSString        *open_family_module;    // 是否打开公会功能
...
@property (nonatomic, assign) NSInteger     open_mobile_code_login;     // 是否有游客登录方式
...
@property(nonatomic, strong) NSString *is_invite_code;
...
@property(nonatomic, strong) NSArray *video_cate; /**<短视频分类*/
@property (nonatomic, assign) NSInteger     is_no_light;                // 1:不需要点亮功能  0:需要（默认）
@property(nonatomic, strong) NSString *sdk_type;
@property(nonatomic, strong) NSString *bogo_beauty_key;


@property(nonatomic, strong) NSString *sts_video_limit;


@property(nonatomic, strong) NSString *tencent_video_sdk_key;
@property(nonatomic, strong) NSString *tencent_video_sdk_licence;
@property(nonatomic, strong) NSString *tencent_live_sdk_key;
@property(nonatomic, strong) NSString *tencent_live_sdk_licence;



@property(nonatomic, strong) NSString *open_noble;//是否开启贵族
@property(nonatomic, strong) NSString *is_open_shop;//是否开启小店
@property(nonatomic, strong) NSString *short_video_store;//视频存储模式0:阿里云；1:腾讯云;2本地服务器

@property(nonatomic, strong) NSString *app_logo;
@property(nonatomic, strong) NSString *must_authentication;//是否强制认证
@property (nonatomic, copy) NSString        *is_open_young;      // 是否开启青少年模式;

@property(nonatomic, copy) NSString *short_video;  //0：列表瀑布流，1：直接播放



@property(nonatomic, strong) NSString *user_unsubscribe;
@property(nonatomic, strong) NSString *user_agreement_link;
@property(nonatomic, strong) NSString *compliance_policy;
