...
@interface BGBaseChatController : BGBaseViewController
{
...
@property(nonatomic, copy) void (^clickBGBlock)(BOOL isRefresh);
...
@property (nonatomic, strong) UIView *mrechargeView; //充值view
