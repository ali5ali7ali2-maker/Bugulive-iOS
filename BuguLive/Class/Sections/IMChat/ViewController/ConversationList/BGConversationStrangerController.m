//
//  BGConversationStrangerController.m
//  BuguLive
//
...
@interface BGConversationStrangerController () <UITableViewDelegate, UITableViewDataSource>

@end

@implementation BGConversationStrangerController
{
