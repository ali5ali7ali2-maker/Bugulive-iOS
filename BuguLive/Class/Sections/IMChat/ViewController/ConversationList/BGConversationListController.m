//
//  BGConversationListController.m
//  BuguLive
//
...
@interface BGConversationListController () <UITableViewDelegate, UITableViewDataSource>

@end

@implementation BGConversationListController
{
