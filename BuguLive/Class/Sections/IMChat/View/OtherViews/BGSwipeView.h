...
- (NSInteger)numberOfItemsInFWSwipeView:(BGSwipeView *)swipeView;
- (UIView *)swipeView:(BGSwipeView *)swipeView viewForItemAtIndex:(NSInteger)index reusingView:(UIView *)view;
...
- (CGSize)swipeViewItemSize:(BGSwipeView *)swipeView;
- (void)swipeViewDidScroll:(BGSwipeView *)swipeView;
- (void)swipeViewCurrentItemIndexDidChange:(BGSwipeView *)swipeView;
- (void)swipeViewWillBeginDragging:(BGSwipeView *)swipeView;
- (void)swipeViewDidEndDragging:(BGSwipeView *)swipeView willDecelerate:(BOOL)decelerate;
- (void)swipeViewWillBeginDecelerating:(BGSwipeView *)swipeView;
- (void)swipeViewDidEndDecelerating:(BGSwipeView *)swipeView;
- (void)swipeViewDidEndScrollingAnimation:(BGSwipeView *)swipeView;
- (BOOL)swipeView:(BGSwipeView *)swipeView shouldSelectItemAtIndex:(NSInteger)index;
- (void)swipeView:(BGSwipeView *)swipeView didSelectItemAtIndex:(NSInteger)index;
