...
@property (strong, nonatomic) BGTLiveController *recoedLiveController;
#pragma mark - 创建 直播上音效界面
+(YunMusicSoundEffectVC *)showYunMusicSoundEffectVCInVC:(BGTLiveController *)vc inView:(UIView *)view showFrame:(CGRect)showFrame oldBGMValue:(CGFloat)oldBGMValue oldMicValue:(CGFloat)oldMicValue;
#pragma mark - 移除 音效界面
/**
 *   移除 音效调节界面
 */
