...
{
    _allEqNames = @[ ASLocalizedString(@"原声"),
                     ASLocalizedString(@"悠扬"),
                     ASLocalizedString(@"圆润"),
                     ASLocalizedString(@"流行"),
                     ASLocalizedString(@"轻松"),
                     ASLocalizedString(@"空灵")];
...
//所有的EQ 配置,比如 @[ ASLocalizedString(@"原声"),ASLocalizedString(@"悠扬"),ASLocalizedString(@"流行")...];
-(NSArray*)getAllEQSet
{
    return _allEqNames;
}
