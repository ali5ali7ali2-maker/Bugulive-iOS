...
- (void)buildDefaultDatas{
    ...
    self.voiceDefaultImage = [UIImage imageNamed:@"du_voice_background002"];
    
    self.voiceAnimationImages = @[
                [UIImage imageNamed:@"du_voice_background001"],
                [UIImage imageNamed:@"du_voice_background002"],
                [UIImage imageNamed:@"du_voice_background004"],
                [UIImage imageNamed:@"du_voice_background005"],
                [UIImage imageNamed:@"du_voice_background006"],
                [UIImage imageNamed:@"du_voice_background007"],
                [UIImage imageNamed:@"du_voice_background008"],
                [UIImage imageNamed:@"du_voice_background009"]];
//                [UIImage imageNamed:@"du_voice_background003"]];
