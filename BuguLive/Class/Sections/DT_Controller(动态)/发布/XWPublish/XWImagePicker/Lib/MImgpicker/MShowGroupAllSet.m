...
- (void)viewDidLoad {
    ...
    UIBarButtonItem *rightBar = [[UIBarButtonItem alloc] initWithTitle:ASLocalizedString(@"确定")style:UIBarButtonItemStylePlain target:self action:@selector(actionRightBar)];
