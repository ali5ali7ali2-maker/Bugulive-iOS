...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        self.closeBtn = [self setButtomNormalImage:@"pl_publishlive_close" selectedImage:@"pl_publishlive_close" text:@"" normalcolor:kWhiteColor selectedColor:kWhiteColor frame:CGRectMake(self.width - 21 - 10, 36, 20, 20) sel:@selector(closeBtnAction:)];
