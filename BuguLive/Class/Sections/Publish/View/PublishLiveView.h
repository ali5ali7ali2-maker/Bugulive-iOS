...
@interface PublishLiveView : BGBaseView<PublishLiveTopDelegate,BeautySettingPanelDelegate,BeautyLoadPituDelegate>{
...
@property(nonatomic, assign) NSString *cid;//分类ID
