...
@interface VoiceLiveTopView : BGBaseView<UITextFieldDelegate>
...
@property (nonatomic, strong)QMUIButton *announcement;
...
@property(nonatomic, strong) NSString *announcement_str;
