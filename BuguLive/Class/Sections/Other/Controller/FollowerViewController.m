...
- (void)initFWUI
{
    ...
    {
        self.navigationItem.title = ASLocalizedString(@"关注");
    }
    else if ([self.type isEqualToString:@"2"])
    {
        self.navigationItem.title = ASLocalizedString(@"粉丝");
    }
    else
    {
        self.navigationItem.title = ASLocalizedString(@"黑名单");
    }
...
- (void)creatView
{
    ...
    if ([self.type isEqualToString:@"1"] && [self.user_id isEqualToString:[GlobalVariables sharedInstance].userModel.user_id])
    {
