...
//            BogoGuideFirstView *firstView = [[NSBundle mainBundle]loadNibNamed:@"BogoGuideFirstView"owner:self options:nil].lastObject;
...
- (void)setLastImageView:(UIImageView *)imageView
{
    ...
    [startBtn setTitle:ASLocalizedString(@"立即体验")forState:UIControlStateNormal];
