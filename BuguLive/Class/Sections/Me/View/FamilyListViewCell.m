...
@property (nonatomic, strong) UILabel * headerNameLabel;     //公会族长名称
@property (nonatomic, strong) UILabel * numberLabel1;            //人数：
@property (nonatomic, strong) UILabel * numberLabel2;            //公会人数
@property (nonatomic, strong) UILabel * numberLabel3;            //人
//@property (nonatomic, strong) UIButton * applyBtn;               //加入公会
...
//        _headView.backgroundColor = [UIColor redColor];
        ...
        _headerNameLabel.text = ASLocalizedString(@"天使的眼泪");
        ...
        _numberLabel1.text = ASLocalizedString(@"人数 :");
...
//    [_headView sd_setImageWithURL:[NSURL URLWithString:model.family_logo]];
    ...
    _headerNameLabel.text = [NSString stringWithFormat:ASLocalizedString(@"族长 : %@"),model.nick_name];
    ...
    _numberLabel3.text = ASLocalizedString(@"人");
