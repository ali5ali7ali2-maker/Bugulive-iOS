...
- (void)creatMianView
{
    ...
    [BGMJRefreshManager refresh:self.listTableView target:self headerRereshAction:@selector(headerReresh) footerRereshAction:@selector(footerReresh)];
}
