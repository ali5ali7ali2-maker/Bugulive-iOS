...
@property(nonatomic, strong) QMUIButton *certificateBtn;//认证view
...
@property(nonatomic, strong) QMUIButton *concertBtn;

@property(nonatomic, strong) userPageModel *model;
...
@property(nonatomic, weak) id<MPCHeadViewDelegate>delegate;
...
@property ( nonatomic,copy) void             (^headViewBgImageBlock) (UIImage *image);
