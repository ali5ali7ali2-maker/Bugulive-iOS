...
//    self.btnAuction.layer.borderWidth = 1.0;
    self.btnAuction.layer.borderColor = [UIColor colorWithHexString:@"#9F23FE"].CGColor;
    self.btnAuction.layer.borderWidth = 1.0f;
    self.btnAuction.backgroundColor = kWhiteColor;
//    Main_textColor;
    [self.btnAuction setTitleColor:[UIColor colorWithHexString:@"#CC45FF"]  forState:UIControlStateNormal];
