...
- (void)awakeFromNib
{
    ...
    self.headImgView1.contentMode = UIViewContentModeScaleAspectFill;
    self.headImgView2.contentMode = UIViewContentModeScaleAspectFill;
    self.headImgView3.contentMode = UIViewContentModeScaleAspectFill;
    
    self.headImgView1.layer.masksToBounds = YES;
    self.headImgView2.layer.masksToBounds = YES;
...
- (void)creatCellWithAuthentication:(int)authentication andHeadImgStr1:(NSString *)string1 andHeadImgStr2:(NSString *)string2 andHeadImgStr3:(NSString *)string3 andUrlStr:(NSString *)urlStr
{
    ...
    {
        [self.headImgView1 sd_setImageWithURL:[NSURL URLWithString:string1] placeholderImage:[UIImage imageNamed:@"ic_add_image_idcard_zm"]];
        [self.headImgView2 sd_setImageWithURL:[NSURL URLWithString:string2] placeholderImage:[UIImage imageNamed:@"ic_add_image_idcard_fm"]];
         [self.headImgView3 sd_setImageWithURL:[NSURL URLWithString:string3] placeholderImage:[UIImage imageNamed:@"ic_add_image_idcard_sc"]];
        if (authentication == 3)
        {
