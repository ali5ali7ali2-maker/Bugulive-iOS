...
//@property (nonatomic, copy) NSString * jia_status;            //公会状态
@property (nonatomic, copy) NSString * family_chieftain;         //是否公会长；0：否、1：是
...
@property(nonatomic, strong) NSString *is_open_shop;


@property(nonatomic, strong) NSString *is_noble_mysterious;
@property(nonatomic, strong) NSString *is_noble_stealth;
...
@property ( nonatomic, copy) NSString *noble_shop;

@property(nonatomic, strong) NSString *shop_status;//店铺审核状态

@property(nonatomic, copy) NSString *is_tips;
