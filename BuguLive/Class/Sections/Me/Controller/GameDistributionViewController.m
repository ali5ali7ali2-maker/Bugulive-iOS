...
- (void)viewDidLoad
{
    ...
    self.title = ASLocalizedString(@"游戏分享收益");
    [self creatView];
}
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section
{
    ...
    if (section == 0)
    {
        titleLabel.text = ASLocalizedString(@"我的推荐人");
    }
    else
    {
        titleLabel.text = ASLocalizedString(@"我的收益");
    }
    return titleLabel;
}
...
- (NSString *)tableView:(UITableView *)tableView titleForHeaderInSection:(NSInteger)section
{
    if (section == 0)
    {
        return ASLocalizedString(@"我的推荐人");
    }
    else
    {
        return ASLocalizedString(@"我的收益");
    }
}
