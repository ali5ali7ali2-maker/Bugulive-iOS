...
- (void)creatMainView
{
    ...
    _shareLabel.text = ASLocalizedString(@"分享至:");
...
- (void)getShareArr
{
    if (_BuguLive.appModel.qq_app_api == 1)//qq空间
    {
        [_shareArray addObject:@"4"];
    }
    if (_BuguLive.appModel.sina_app_api == 1)//新浪
    {
        [_shareArray addObject:@"0"];
    }
    if (_BuguLive.appModel.wx_app_api == 1)//朋友圈
    {
       [_shareArray addObject:@"1"];
    }
    if (_BuguLive.appModel.wx_app_api == 1)//微信
    {
       [_shareArray addObject:@"2"];
    }
    if (_BuguLive.appModel.qq_app_api == 1)//qq
    {
