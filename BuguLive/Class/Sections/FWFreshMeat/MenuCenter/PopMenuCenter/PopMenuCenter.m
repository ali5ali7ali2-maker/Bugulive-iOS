...
-(void)showPopView
{
    ...
    switch (status)
    {
        ...
        case AVAuthorizationStatusRestricted:
            ...
            {
                UIAlertController *alertC = [UIAlertController alertControllerWithTitle:ASLocalizedString(@"相册权限")message:ASLocalizedString(@"无法访问相册，请在系统设置中允许访问")preferredStyle:UIAlertControllerStyleAlert];
                ...
                UIAlertAction *confirmAction = [UIAlertAction actionWithTitle:ASLocalizedString(@"设置")style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
...
-(void)showMenu
{
    ...
    NSMutableArray *titleStrMArray = @[ASLocalizedString(@"发起直播"),
                                       ASLocalizedString(@"发布短视频"),
                                       ].mutableCopy;
