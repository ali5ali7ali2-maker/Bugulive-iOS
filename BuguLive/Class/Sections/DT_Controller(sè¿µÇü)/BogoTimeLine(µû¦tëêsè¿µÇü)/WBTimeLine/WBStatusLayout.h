...
#define kWBCellNamePaddingLeft 10 // cell 名字和 avatar 之间留白
#define kWBCellContentWidth (kScreenW - 2 * kWBCellPadding) // cell 内容宽度
#define kWBCellNameWidth (kScreenW - 110) // cell 名字最宽限制

#define kWBCellTagPadding 8         // tag 上下留白
#define kWBCellTagNormalHeight 16   // 一般 tag 高度
#define kWBCellTagPlaceHeight 24    // 地理位置 tag 高度

#define kWBCellToolbarHeight 40     // cell 下方工具栏高度
...
#define kWBCellTextHighlightColor UIColorHex(9F64FF) // Link 文本色
...
// 以下是数据
@property (nonatomic, strong) WBModel *status;
...
//地理位置和话题
@property (nonatomic, assign) CGFloat locationHeight; // 工具栏
