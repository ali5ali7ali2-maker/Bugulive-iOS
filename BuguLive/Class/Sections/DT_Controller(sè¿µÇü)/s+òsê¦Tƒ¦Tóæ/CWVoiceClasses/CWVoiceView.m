...
- (void)setupBottomViewSubviews {
    CGFloat margin = 10;
    NSArray *titleArr = @[ASLocalizedString(@"变声"),ASLocalizedString(@"对讲"),ASLocalizedString(@"录音")];
...
//    [self.bottomView addSubview:label];
    ...
    recordLabel.center = CGPointMake(self.centerY, self.bottomView.cw_height / 2.0);
