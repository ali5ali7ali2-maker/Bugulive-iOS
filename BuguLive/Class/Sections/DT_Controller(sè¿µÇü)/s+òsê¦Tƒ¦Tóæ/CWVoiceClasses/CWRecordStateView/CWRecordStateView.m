...
- (UILabel *)titleLb {
    if (_titleLb == nil) {
        ...
        label.text = ASLocalizedString(@"按住说话");
...
- (void)setRecordState:(CWRecordState)recordState {
    ...
    switch (recordState) {
        case CWRecordStateDefault:
            self.titleLb.text = ASLocalizedString(@"按住说话");
            [self updateLableFrame:self.titleLb];
            break;
        case CWRecordStateClickRecord:
            self.titleLb.text = ASLocalizedString(@"点击录音");
            [self updateLableFrame:self.titleLb];
            break;
        case CWRecordStateTouchChangeVoice:
            self.titleLb.text = ASLocalizedString(@"按住变声");
            [self updateLableFrame:self.titleLb];
            break;
        case CWRecordStateListen:
            self.titleLb.text = ASLocalizedString(@"松手试听");
            [self updateLableFrame:self.titleLb];
            break;
        case CWRecordStateCancel:
            self.titleLb.text = ASLocalizedString(@"松手取消发送");
            [self updateLableFrame:self.titleLb];
            break;
        ...
        case CWRecordStatePrepare:
            self.titleLb.text = ASLocalizedString(@"准备中");
            [self updateLableFrame:self.titleLb];
...
// 结束录音
- (void)endRecord {
    NSLog(ASLocalizedString(@"endRecord---------结束录音"));
//    NSLog(@"%@",self.allLevels);
