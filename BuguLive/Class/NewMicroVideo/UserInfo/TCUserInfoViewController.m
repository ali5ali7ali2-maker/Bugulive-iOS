...
-(void)initUI
{
    ...
    //    TCUserInfoCellItem *setItem = [[TCUserInfoCellItem alloc] initWith:ASLocalizedString(@"编辑个人信息")value:nil type:TCUserInfo_Edit action:^(TCUserInfoCellItem *menu, TCUserInfoTableViewCell *cell) {
    //        [ws onEditUserInfo:menu cell:cell]; } ];
    ...
    TCUserInfoCellItem *getSupportItem = [[TCUserInfoCellItem alloc] initWith:NSLocalizedString(ASLocalizedString(@"获取技术支持服务"), nil) value:nil type:TCUserInfo_About action:^(TCUserInfoCellItem *menu, TCUserInfoTableViewCell *cell) { [ws onShowAppSupport:menu cell:cell]; } ];
...
{
    NSString *message = [@[L(ASLocalizedString(@"关注公众号“腾讯云视频”")), L(ASLocalizedString(@"给公众号发送“小视频”"))] componentsJoinedByString:@"\n"];
    UIAlertView *alert = [[UIAlertView alloc] initWithTitle:NSLocalizedString(ASLocalizedString(@"获取技术支持服务"), nil) message:message delegate:nil cancelButtonTitle:NSLocalizedString(@"Common.Close", nil) otherButtonTitles:nil, nil];
    [alert show];
}
...
{
//    [TCUtil report:xiaoshipin_about_sdk userName:nil code:0 msg:ASLocalizedString(@"点击关于SDK")];
