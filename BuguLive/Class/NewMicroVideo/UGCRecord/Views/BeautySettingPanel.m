...
- (UISlider *)filterSlider
{
    if(!_filterSlider){
        ...
        [_filterSlider setMinimumTrackTintColor:RGB(235, 100, 86)];
        [_filterSlider setMaximumTrackTintColor:RGB(166, 166, 165)];
        [_filterSlider setThumbImage:[UIImage imageNamed:@"beauty_slider"] forState:UIControlStateNormal];
...
- (UILabel *)filterLabel
{
    if(!_filterLabel){
        ...
        _filterLabel.text = @"0";
        [_filterLabel setTextColor:UIColorFromRGB(0xFF584C)];
    }
    return _filterLabel;
}
