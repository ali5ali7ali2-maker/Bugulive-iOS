...
#define     AppDoMainUrlArray [NSArray arrayWithObjects:@"http://intl.liveapi.bogokj.com", nil]
...
#define     H5InitUrlStr            @"http://live.bogokj.com/app.php?act=init"
// app的H5页面主页（初始化地址失败时使用，非h5项目不需要填写该项）
#define     H5MainUrlStr            @"http://live.bogokj.com/index.php?show_prog=1"
...
#define TXRTMPLicence @"http://license.vod2.myqcloud.com/license/v1/b9c4190bec109303af70d28f8623236c/TXLiveSDK.licence"
